export function resetPositions({
  ...
  gameStateRef.current.ballSpeedX = (Math.random() > 0.5 ? 1 : -1) * gameStateRef.current.ballBaseSpeed;
  gameStateRef.current.ballSpeedY = (Math.random() * 2 - 1) * gameStateRef.current.ballBaseSpeed;
